<%@ Page Title="" Language="C#" MasterPageFile="~/presentationLayer/Main.Master" AutoEventWireup="true" CodeBehind="LandingPage.aspx.cs" Inherits="AptUni.presentationLayer.LandingPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <p>
                            An aptitude test is a way to measure a job candidate’s cognitive abilities,
                            work behaviours, or personality traits. Aptitude tests
                            will examine your numeracy, logic and problem-solving skills, as well
                            as how you deal with work situations. They are a proven method to assess employability skills.
                        </p>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <p>
                            There are a number of different types of aptitude test due to the range of cognitive capabilities
                            and employer priorities. At AptUni, we provide industry standard aptitude or
                            psychometric tests for banking, accountancy, finance, law, engineering, business, marketing and vocational fields.
                        </p>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <p>
                            Try an aptitude test from the various test types below to prepare for your psychometric tests.
                            ...
                            benchmark and the full solutions to all the questions.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="box-part text-center border rounded-circle bg-light">
                    ...
                    <div class="text">
                        <a href="Numerical.aspx">4 Tests | 4 Questions Per Test</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="box-part text-center border rounded-circle bg-light">
                    ...
                    <div class="text">
                        <a href="Diagrammatic.aspx">2 Tests | 4 Questions Per Test</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="box-part text-center border rounded-circle bg-light">
                    ...
                    <div class="text">
                        <a href="Verbal.aspx">3 Tests | 4 Questions Per Test</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="box-part text-center border rounded-circle bg-light">
                    ...
                    <div class="text">
                        <a href="Situational.aspx">1 Test | 4 Questions</a>
                    </div>
                </div>
            </div>
        </div>
